                    ...
                    <nav>
                      <ul>
                        ...
                        <li className="msg-trigger">
                          <a className="msg-trigger-btn" href="#a">
                            message
                          </a>
                        ...
                        <li className="notification-trigger">
                          <a className="msg-trigger-btn" href="#b">
                            notification
                          </a>
                            ...
                            <ul className="dropdown-msg-list">
                              <li className="msg-list-item d-flex justify-content-between">
                                ...
                                <div className="msg-content notification-content">
                                  ...
                                  <p>
                                    and 35 other people reacted to your photo
                                  </p>
                                </div>
                                {/* message content end */}
                                {/* message time start */}
                              ...
                              <li className="msg-list-item d-flex justify-content-between">
                                ...
                                <div className="msg-content notification-content">
                                  ...
                                  <p>
                                    and 20 other people reacted to your photo
                                  </p>
                                </div>
                                {/* message content end */}
                                {/* message time start */}
                              ...
                              <li className="msg-list-item d-flex justify-content-between">
                                ...
                                <div className="profile-thumb">
                                  <figure className="profile-thumb-middle">
                                    <img
                                      src="assets/images/profile/profile-small-6.jpg"
                                      alt="profile picture"
                                    />
                                  </figure>
                                </div>
                                ...
                                <div className="msg-content notification-content">
                                  ...
                                  <p>
                                    and 55 other people reacted to your post
                                  </p>
                                </div>
                                {/* message content end */}
                                {/* message time start */}
