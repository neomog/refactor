...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a class="brand" href="#">Adda - Social Network HTML Template</a>
...
<div class="container" id="documenter_content"> 
  <div id="documenter-cover">
    <div class="masthead">
      <h1 style="text-align: center">Adda - Social Network HTML Template</h1>
      <p style="text-align: center">Created: 10.01.2020</p>     
		...
		<ol>
			<li>
				...
				<ul>				   
					...
					<li>Upload the files inside <strong>adda</strong> folder.</li>						
				</ul>
			</li>				
		</ol>
  </section>
  ...
  <section id="reading_setting">
    <div class="page-header">
      ...
      <hr class="notop">
		<ol>			
			<ul>			   
				<li>index.html is for default newspage</li>
        <li>about.html is for about page</li>
        <li>profile.html is for profile page</li>
        <li>friends.html is for friends list page</li>
        <li>photos.html is for photos page</li>
        <li>signup.html is for login & signup page</li>
			</ul>
		</ol>	  
    </div>   
  </section>
...
<!--Created using ToHtml.com on 2019-06-01 09:50:13 UTC -->
		</pre>
  </section>
    ...
    <div class="page-header">
      ...
      <hr class="notop">
		...
		<pre>	
            ...
            &lt;!-- bicon css file--&gt;
            &lt;link href="assets/css/vendor/bicon.min.css" rel="stylesheet"&gt;
            &lt;!-- flaticon css file--&gt;
            &lt;link href="assets/css/vendor/flaticon.css" rel="stylesheet"&gt;
            &lt;!-- plyr plugin css --&gt;
            &lt;link href="assets/css/plugins/plyr.css" rel="stylesheet"&gt;
            &lt;!-- slick plugin css --&gt;
            &lt;link href="assets/css/plugins/slick.min.css" rel="stylesheet"&gt;
            &lt;!-- perfect-scrollbar plugin css --&gt;
            &lt;link href="assets/css/plugins/perfect-scrollbar.css" rel="stylesheet"&gt;
            &lt;!-- lightgallery plugin css --&gt;
            &lt;link href="assets/css/plugins/lightgallery.min.css" rel="stylesheet"&gt;
            &lt;!-- Theme main style --&gt;
  ...
  <section id="theme_options1">
    <div class="page-header">
      ...
      <hr class="notop">
        ...
        &lt;!-- perfect-scrollbar plugins js --&gt;
        &lt;script src="assets/js/plugins/perfect-scrollbar.min.js"&gt;&lt;/script&gt;
        &lt;!-- lightgallery plugins js --&gt;
        &lt;script src="assets/js/plugins/lightgallery-all.min.js"&gt;&lt;/script&gt;
        &lt;!-- imagesloaded plugins js --&gt;
  ...
  <section id="thanks">
    ...
    <h3 style="margin: 18px 0px 0px; padding: 0px; border: 0px; outline: 0px; font-weight: 100; font-size: 26px; font-family: Arial, verdana, arial, sans-serif; vertical-align: baseline; color: rgb(56, 56, 56);"> codecarnival</h3>
  </section>
  <hr />
  <footer>
    <p>Copyright codecarnival 2020 made with the <a href="#">Documenter v2.0</a></p>
  </footer>
</div>
<!-- /container --> 
